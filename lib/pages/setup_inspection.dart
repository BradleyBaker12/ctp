...
class _SetupInspectionPageState extends State<SetupInspectionPage> {
  ...
  void _onDaySelected(DateTime selectedDay, DateTime focusedDay) {
    ...
    setState(() {
      ...
      if (_selectedDays.any((day) => _isSameDay(day, selectedDay))) {
        ...
        print('New selected day: $selectedDay');
      }

      _selectedDay = selectedDay;
    });

    print('Selected days list: $_selectedDays');
  }
  ...
  Future<void> _saveInspectionDetails() async {
    if (_selectedDays.isEmpty || _dateTimeSlots.isEmpty) {
      _showErrorDialog('Please select at least one date and time.');
      return;
    }
    ...
    _showSuccessDialog('Inspection details saved successfully.');
  }
  ...
  Future<void> _addAnotherLocation() async {
    ...
    _showSuccessDialog('Location added successfully.');
  }
